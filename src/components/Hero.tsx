        ...
        >
          <div className="space-y-4">
            <motion.p
              ...
              className="text-sm text-gray-600 dark:text-gray-400 font-medium tracking-wide uppercase"
            >
              Hello, I am
            </motion.p>
          ...
          >
            <motion.button
              ...
              className="inline-flex items-center justify-center px-8 py-4 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent"
