...
const experiences = [
  {
    ...
    description: [
      "Led the development of a customer-facing dashboard serving 10,000+ users, resulting in 40% increase in user engagement",
      "Architected and implemented a component library used across 5 different products, reducing development time by 60%",
  ...
  },
  {
    ...
    description: [
      "Developed and maintained the main product interface for a B2B SaaS platform",
      "Implemented real-time features using WebSocket connections, improving user experience",
      "Optimized application performance, reducing initial load time by 50%",
      "Participated in code reviews and contributed to technical decision-making",
    ],
    technologies: ["React", "Redux", "SCSS", "Node.js", "MongoDB"],
  ...
  },
  {
    ...
    description: [
      "Built responsive websites and landing pages for various clients using modern web technologies",
      "Collaborated with designers to implement creative and interactive user interfaces",
